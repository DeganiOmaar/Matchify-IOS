...
struct MissionEditView: View {
    @StateObject private var vm: MissionEditViewModel
    @Environment(\.dismiss) private var dismiss
    
    let onMissionUpdated: () -> Void
    
    init(mission: MissionModel, onMissionUpdated: @escaping () -> Void) {
        self._vm = StateObject(wrappedValue: MissionEditViewModel(mission: mission))
        self.onMissionUpdated = onMissionUpdated
    }
